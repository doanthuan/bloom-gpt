...
if __name__ == "__main__":
    questions = read_jsonl("table/question_instruct.jsonl", key="question_id")

    bloomz_answers = read_jsonl("table/answer_bloomz_instruct.jsonl", key="question_id")
    gptj_answers = read_jsonl("table/answer_gptj_instruct.jsonl", key="question_id")
    gpt35_answers = read_jsonl("table/answer_gpt35.jsonl", key="question_id")
