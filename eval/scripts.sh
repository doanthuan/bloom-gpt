...
python -m eval.eval_gpt_review -q eval/data/question_doctor.jsonl -a eval/data/answer_gpt35_doctor.jsonl eval/data/answer_bloomz_doctor.jsonl -p eval/data/prompt.jsonl -r eval/data/reviewer.jsonl -o eval/data/review_bloomz_doctor_gpt4.jsonl
